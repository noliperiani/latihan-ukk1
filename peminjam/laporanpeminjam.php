    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr><td>".$row["PeminjamanID"]."</td><td>".$row["UserID"]."</td><td>".$row["BukuID"]."</td><td>".$row["TanggalPeminjaman"]."</td><td>".$row["TanggalPengembalian"]."</td><td>".$row["StatusPengembalian"]."</td></tr>";
            }
            echo "</table>";
        } else {
